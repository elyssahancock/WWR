(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[3729],{"/oRJ":function(e,t,n){"use strict"
n.d(t,"a",(function(){return i}))
function i(e){const t="about:blank"
try{const n=new URL(e,window.location.origin)
if("javascript:"===n.protocol)return t
return e}catch(e){return t}}},"16Fr":function(e,t,n){"use strict"
n.r(t)
var i=n("ouhR")
var s=n.n(i)
n("CsJK")
...
e.fillWindowWithMe()
e.loadDocPreview(s.a.merge(r,e.data()))})},"65NJ":function(e,t,n){"use strict"
var i=n("ouhR")
var s=n.n(i)
n("w2hD")
...
return this}},CsJK:function(e,t,n){"use strict"
var i=n("ik22")
var s=n("HGxv")
var a=n("8WeW")
...
c.a.isPreviewable=function(e,t){return _[e]&&(!t||!i["a"]["disable"+c.a.capitalize(t)+"Previews"]&&_[e][{scribd:0,google:1}[t]])}
...
Object(u["a"])("Doc Previews",e,JSON.stringify(n,["attachment_id","submission_id","mimetype","crocodoc_session_url","canvadoc_session_url"]))}}if(n.crocodoc_session_url){const e=Object(d["a"])(n.crocodoc_session_url)
...
e()}})}}else n.attachment_preview_processing?t.html("<p>"+Object(l["a"])(o.t("errors.document_preview_processing","The document preview is currently being processed. Please try again later."))+"</p>"):t.html("<p>"+Object(l["a"])(o.t("errors.cannot_view_document_in_canvas","This document cannot be displayed within Canvas."))+"</p>")}))}},aq8L:function(e,t,n){"use strict"
var i=n("HGxv")
var s=n("8WeW")
...
n=r()(e.message).dialog(r.a.extend({},{modal:true,close:s,buttons:[{text:a.t("#buttons.cancel","Cancel"),click(){r()(this).dialog("close")}},{text:a.t("#buttons.delete","Delete"),class:o,click(){i=true
...
return this}
r.a},lBOK:function(e,t,n){"use strict"
var i=n("ouhR")
var s=n.n(i)
...
else if("middle"===e.vertical)o=n.outerHeight()/2-a.height/2
else{o=parseInt(e.vertical,10)
isNaN(o)&&(o=0)}let r=0
if(e.horizontal)if("left"===e.horizontal);else if("right"===e.horizontal)r=n.outerWidth()-a.width
else if("right!"===e.horizontal){r="ltr"===t?n.outerWidth()+5:-5-(a.width||16)
this.css({"margin-inline-end":"16px"})}else if("middle"===e.horizontal)r=n.outerWidth()/2-a.width/2
else{r=parseInt(e.horizontal,10)
isNaN(r)&&(r=0)}const c=n.zIndex()+1
const l=s()(document.createElement("div")).addClass("loading_image_holder")
const u=s()(document.createElement("img")).attr("src",a.url)
l.append(u)
i=n.data("loading_images")||[]
i.push(l)
n.data("loading_images",i)
if(n.css("position")&&"static"!==n.css("position")){l.css({zIndex:c,position:"absolute",top:o,left:r})
n.append(l)}else{const t=n.offset()
let i=t.top,a=t.left
e.vertical&&(i+=o)
e.horizontal&&(a+=r)
l.css({zIndex:c,position:"absolute",top:i,left:a})
...
s.a.fn.loadingImage=s.a.fn.loadingImg}}])

//# sourceMappingURL=file_show-c-8cec9359f0.js.map